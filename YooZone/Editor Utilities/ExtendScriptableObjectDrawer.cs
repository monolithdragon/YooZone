...
namespace YooZone.EditorUtilities {
    /// <summary>
    ...
    public class ExtendScriptableObjectDrawer : PropertyDrawer {
        private const int bottonWidth = 66;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (propertySO != null || property.objectReferenceValue == null) {
                propertyRect.width -= bottonWidth;
            }
            ...
            var buttonRect = new Rect(position.x + position.width - bottonWidth, position.y, bottonWidth, EditorGUIUtility.singleLineHeight);
                ...
                if (property.isExpanded) {
                    ...
                    if (prop.NextVisible(true)) {
                        do {
                            ...
                            EditorGUI.PropertyField(new Rect(position.x, y, position.width - bottonWidth, height), prop, true);
        ...
        public static T GUILayoutExtend<T>(GUIContent label, T objectReferenceValue, ref bool isExpanded) where T : ScriptableObject {
            ...
            if (objectReferenceValue != null) {
                ...
                if (GUILayout.Button("Create", GUILayout.Width(bottonWidth))) {
                    var selectedAssetPath = "Assets";
